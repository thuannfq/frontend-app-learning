...
const messages = defineMessages({
  ...
  certAlt: {
    ...
    defaultMessage: 'Giấy chứng nhận ví dụ',
  ...
  goalReminderDetail: {
    ...
    defaultMessage: 'Nếu chúng tôi nhận thấy bạn chưa hoàn thành mục tiêu của mình, chúng tôi sẽ gửi cho bạn lời nhắc qua email.',
    description: 'It describe to learner what is goal reminder service',
  },
  goalUnsure: {
    id: 'learning.outline.goalUnsure',
    defaultMessage: 'Chưa chắc nữa',
  },
  handouts: {
  ...
  proctoringInfoPanel: {
    ...
    defaultMessage: 'Khóa học này bao gồm các bài kiểm tra được giám sát',
  ...
  resumeBlurb: {
    ...
    defaultMessage: 'Tiếp tục nơi bạn đã dừng lại',
  ...
  setGoal: {
    ...
    defaultMessage: 'Để bắt đầu, hãy đặt mục tiêu khóa học bằng cách chọn tùy chọn bên dưới mô tả đúng nhất kế hoạch học tập của bạn.',
    description: 'In indicate to learner how to set or use the goal reminder service',
  },
  setGoalReminder: {
    id: 'learning.outline.setGoalReminder',
    defaultMessage: 'Đặt nhắc nhở về mục tiêu',
  ...
  setWeeklyGoalDetail: {
    ...
    defaultMessage: 'Đặt mục tiêu sẽ thúc đẩy bạn hoàn thành khóa học. Bạn luôn có thể thay đổi nó sau.',
  ...
  upgradeTitle: {
    ...
    defaultMessage: 'Theo đuổi một chứng chỉ đã được xác nhận',
  ...
  otherCourseApprovedProctoringStatus: {
    ...
    defaultMessage: 'Đã được phê duyệt trong một khóa học khác',
  ...
  proctoringCurrentStatus: {
    ...
    defaultMessage: 'Tình trạng tham gia hiện tại:',
  ...
  notStartedProctoringMessage: {
    ...
    defaultMessage: 'Bạn chưa bắt đầu kỳ thi đầu vào của mình.',
  ...
  startedProctoringMessage: {
    ...
    defaultMessage: 'Bạn đã bắt đầu kỳ thi đầu vào của mình.',
  ...
  verifiedProctoringMessage: {
    ...
    defaultMessage: 'Kỳ thi đầu vào của bạn đã được phê duyệt trong khóa học này.',
  ...
  rejectedProctoringMessage: {
    ...
    defaultMessage: 'kỳ thi đầu vào của bạn đã bị từ chối. Vui lòng thử tham gia lại.',
  ...
  errorProctoringMessage: {
    ...
    defaultMessage: 'Đã xảy ra lỗi trong kỳ thi đầu vào của bạn. Vui lòng thử tham gia lại.',
  ...
  otherCourseApprovedProctoringMessage: {
    ...
    defaultMessage: 'Kỳ thi đầu vào của bạn đã được phê duyệt ở một khóa học khác.',
  ...
  otherCourseApprovedProctoringDetail: {
    ...
    defaultMessage: 'Nếu thiết bị của bạn đã thay đổi, chúng tôi khuyên bạn nên hoàn thành kỳ thi đầu vào của khóa học này để đảm bảo rằng thiết lập của bạn vẫn đáp ứng các yêu cầu để giám sát.',
  ...
  expiringSoonProctoringMessage: {
    ...
    defaultMessage: 'Hồ sơ đăng ký của bạn đã được phê duyệt. Tuy nhiên, trạng thái tham gia của bạn sắp hết hạn. Vui lòng hoàn tất quá trình đăng ký lại để đảm bảo rằng bạn có thể tiếp tục tham gia các kỳ thi giám sát.',
  ...
  expiredProctoringMessage: {
    ...
    defaultMessage: 'Trạng thái tham gia của bạn đã hết hạn. Vui lòng hoàn tất quá trình đăng ký lại để tiếp tục thực hiện các bài kiểm tra được giám sát.',
  ...
  proctoringPanelGeneralInfo: {
    ...
    defaultMessage: 'Bạn phải hoàn tất quá trình làm quen trước khi tham gia bất kỳ kỳ thi giám sát nào. ',
  ...
  proctoringPanelGeneralInfoSubmitted: {
    ...
    defaultMessage: 'Hồ sơ của bạn đang được xem xét.',
  ...
  proctoringPanelGeneralTime: {
    ...
    defaultMessage: 'Quá trình xem xét hồ sơ nhập học có thể mất hơn 2 ngày làm việc.',
  ...
  proctoringOnboardingButton: {
    ...
    defaultMessage: 'Hoàn tất giới thiệu',
  ...
  proctoringOnboardingPracticeButton: {
    ...
    defaultMessage: 'Xem bài kiểm tra nhập môn',
  ...
  proctoringOnboardingButtonNotOpen: {
    ...
    defaultMessage: 'Nhập học mở vào: {releaseDate}',
  ...
  proctoringReviewRequirementsButton: {
    ...
    defaultMessage: 'Xem lại hướng dẫn và yêu cầu hệ thống',
  ...
  proctoringOnboardingButtonPastDue: {
    ...
    defaultMessage: 'Tham gia quá hạn',
